...
import { Search, RefreshCw, Copy, Download, WrapText, ArrowDownToLine, Filter, Eraser, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, Type, Activity, Moon, Sun, Box, Star, Clock3, Tags } from 'lucide-react'
...
export function ContainerLogsPanel() {
  ...
  const [containerPaneCollapsed, setContainerPaneCollapsed] = useState(() => localStorage.getItem('docker_copilot_logs_container_pane') !== 'expanded')
