...
type BotConfigReq struct {
	...
	RichInteractionsEnabled  bool            `json:"richInteractionsEnabled,optional"`
	ParseMode                string          `json:"parseMode,optional"`
	...
	QQBotEnabled             bool            `json:"qqbotEnabled,optional"`
	QQBotAppID               string          `json:"qqbotAppId,optional"`
	QQBotAppSecret           string          `json:"qqbotAppSecret,optional"`
	QQBotSandbox             bool            `json:"qqbotSandbox,optional"`
	QQBotEventMode           string          `json:"qqbotEventMode,optional"`
	QQBotAllowedUserOpenIDs  string          `json:"qqbotAllowedUserOpenids,optional"`
	QQBotAllowedGroupOpenIDs string          `json:"qqbotAllowedGroupOpenids,optional"`
	QQBotNotifyTargets       string          `json:"qqbotNotifyTargets,optional"`
	QQBotMarkdownEnabled     bool            `json:"qqbotMarkdownEnabled,optional"`
	QQBotButtonsEnabled      bool            `json:"qqbotButtonsEnabled,optional"`
